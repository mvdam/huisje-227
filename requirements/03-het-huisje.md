...
| ------ | ---------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- |
| US-020 | As a visitor, I want to view detailed information about the holiday house and its rooms, so that I can decide if it suits my needs | [HetHuisje.tsx](../src/pages/HetHuisje.tsx) |

## Functional Requirements

| ID     | Requirement                                                                                                                                                                                                            | Source                                                                      | Status |
| ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ------ |
| FR-050 | The page shall display a hero section with heading "Het huisje" and breadcrumb trail (Home > Het huisje)                                                                                                               | [HetHuisje.tsx](../src/pages/HetHuisje.tsx)                                    | ✅     |
| FR-051 | The page shall display a check-availability form identical to the homepage (Aankomst, Vertrek, Volwassenen, Kinderen) with Dutch labels                                                                                | [HetHuisje.tsx](../src/pages/HetHuisje.tsx)                                   | ✅     |
| FR-052 | The page shall display property descriptions and images specific to Capfun De Bongerd 227 (not the template "Single Room $90/night", "Family Room $120/night", "Presidential Room $250/night")                         | [HetHuisje.tsx](../src/pages/HetHuisje.tsx)                                  | ✅     |
| FR-053 | The "Great Offers" section shall be replaced with real property content (e.g., special rates, seasonal offers) or removed                                                                                              | [HetHuisje.tsx](../src/pages/HetHuisje.tsx)                                  | ✅     |
